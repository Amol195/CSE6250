...
-- ***** your code below *****
FROM (SELECT patient_id, count(event_id) AS event_count FROM alive_events GROUP BY patient_id) p;
...
SELECT avg(event_count), min(event_count), max(event_count)
-- ***** your code below *****
FROM (SELECT patient_id, count(*) AS event_count FROM dead_events GROUP BY patient_id) p;
...
-- ***** your code below *****
FROM (SELECT patient_id, count(distinct(time)) as encounter_count FROM alive_events GROUP BY patient_id) p;
...
SELECT avg(encounter_count), min(encounter_count), max(encounter_count)
-- ***** your code below *****
FROM (SELECT patient_id, count(distinct(time)) as encounter_count FROM dead_events GROUP BY patient_id) p;
...
-- ***** your code below *****
FROM (SELECT patient_id, DATEDIFF(max(time),min(time)) as record_length FROM alive_events GROUP BY patient_id) p;
...
SELECT avg(record_length), min(record_length), max(record_length)
-- ***** your code below *****
FROM (SELECT patient_id, DATEDIFF(max(time),min(time)) as record_length FROM dead_events GROUP BY patient_id) p;
